# Cursor-Parity for Wylde — Visual Graph + Symbol-Aware AI Context
...
This plan itself lives on `feat/cursor-parity-plan` as a scope doc, in the same pattern PR #12 used for the workspaces redesign.
...
This is the slice that takes Wylde from "AI that knows your codebase superficially" to "AI that reasons about your code structurally." It's the Cursor-killer slice.
...
Total: ~2 weeks of focused work for the whole plan. Slices A-E are the core of the "Cursor-parity + edge" payoff and could ship in ~1 week.
