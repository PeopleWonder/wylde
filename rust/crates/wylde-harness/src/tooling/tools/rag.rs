    ...
    reg.insert(entry_deferred(
        ...
        vec![
            ...
            param_default(
                "limit",
                "number",
                "Max chunks returned (clamped 1..50)",
                json!(8),
            ),
            param(
                "query_vector",
            ...
            param(
                ...
                "string",
                false,
                "Restrict to one tier (core/episodic/semantic/procedural)",
            ),
        ],
        false,
        "7",
    ...
    reg.insert(entry_active(
        ...
        vec![
            param(
                ...
                "array",
                false,
                "Paths relative to target_path (e.g. ['core'])",
            ),
            param(
                "target_path",
                "string",
                false,
                "Workspace root the ingest workflow walks",
            ),
            param_default(
                "workspace_id",
                "string",
                "Logical workspace bucket",
                json!("default"),
            ),
            param_default(
                "force",
    ...
    reg.insert(entry_active(
        ...
        vec![
            param(
                ...
                "string",
                false,
                "Workspace root to rebuild against",
            ),
            param_default(
                "workspace_id",
                "string",
    ...
    reg.insert(entry_active(
        ...
        vec![
            ...
            param(
                ...
                "number",
                false,
                "Delete memories created before this unix timestamp",
            ),
            param(
                "memory_type",
                "string",
                false,
                "Delete only memories of this tier",
            ),
            param(
                "score_lt",
                "number",
                false,
                "Delete memories whose score is strictly below this value",
            ),
            param_default(
                "max_delete",
                "number",
                "Safety cap (clamped 1..10000)",
                json!(500),
            ),
        ],
        true,
    ...
    reg.insert(entry_active(
        ...
        vec![
            param(
                ...
                "string",
                true,
                "query_id returned by a prior rag_ask call",
            ),
    ...
    reg.insert(entry_active(
        ...
        vec![
            ...
            param_default(
                "only_gated",
                "boolean",
                "Restrict to gated rows",
                json!(true),
            ),
            param_default(
                "include_trace",
                "boolean",
                "Include retrieval-trace JSON",
                json!(false),
            ),
            param(
                "since",
                "number",
                false,
                "Only include rows with ts >= this value",
            ),
        ],
        false,
    ...
    reg.insert(entry_active(
        ...
        vec![
            param_default(
                "dead_only",
                "boolean",
                "If true, return only chunks with zero citations",
                json!(false),
            ),
